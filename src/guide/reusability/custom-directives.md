...
### Argumentos de los Hooks {#hook-arguments}
...
## Abreviación de Función {#function-shorthand}
...
Cuando se usan en componentes, las directivas personalizadas siempre se aplicarán al nodo raíz de un componente, de forma similar a los [Atributos de Fallthrough](/guide/components/attrs).
